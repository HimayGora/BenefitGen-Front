  ...
  <div class="w-full max-w-auto">
    <form @submit.prevent="checkKey" class="bg-gray-800 shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
      ...
      <div class="flex items-center justify-center">
        <button 
          type="submit"
          class="bg-amber-500 hover:bg-amber-600 text-stone-100 font-bold py-2 px-6 rounded-lg focus:outline-none focus:shadow-outline transition-colors duration-300"
        >
          Verify Key
        </button>
      </div>
